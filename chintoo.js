...
puppeteer.launch().then(async browser => {
  ...
  await page.goto("http://chintoo.com/comic/?random");

  const imgs = await page.$$eval(".entry-comic img", imgs =>
    imgs.map(img => img.getAttribute("src"))
  );

  let tweet_msg =
    "Chintoo is the most popular & favorite #marathi #cartoon #comicstrip that has brought a smile to several #Punekars over the years.\n\nEnjoy your daily dose of @Chintoo_toon #Chintoo\n\n#pune #sakal #MondayVibes #TuesdayThoughts #WednesdayWisdom #ThursdayThoughts #FridayFeeling #weekendvibes #WeekendKaVaar";
