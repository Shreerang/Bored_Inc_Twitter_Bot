  ...
  .then(function (response) {
    ...
    axios.get('https://deckofcardsapi.com/api/deck/' + deck_id + '/draw/?count=1')
      .then(function (response) {
        ...
        dealt_cards_str = dealt_cards_str + dealt_cards + '\n#cards #houseofcards #Suits #spades #hearts #clubs #poker #pokeronline #deckofcards #cardgames #MondayVibes  #TuesdayThoughts #WednesdayWisdom #ThursdayThoughts #FridayFeeling #weekendvibes #WeekendKaVaar'
