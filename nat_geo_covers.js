...
axios
  .get(
    "https://www.nationalgeographic.com/magazine/national-geographic-magazine-50-years-of-covers/_jcr_content/presentation-mode.pres.json"
  )
  .then(function (response) {
    ...
    nat_geo_img_title = response.data.items[0].items
      ? response.data.items[0].items[day].title
      : "";
